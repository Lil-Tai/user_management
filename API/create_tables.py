...
create_table_participants = "CREATE TABLE IF NOT EXISTS participants (id INTEGER PRIMARY KEY, id_events INTEGER, id_users INTEGER, CONSTRAINT fk_event FOREIGN KEY(id_events) REFERENCES events(id) ON DELETE CASCADE)"
